    ...
    [:div.ui.container
     [:div {:class "ui divided grid"}
      [:div {:class "ui stackable two column grid"}
       [:div.column {:class "aboutPadding ten wide"}
        [:h2 "Story"]
       ...
       [:div.column.six.wide 
        [:img {:class "ui fluid image koompi-about-image" :src "img/koompi-about.svg"}]]]]]]

   [:div.ui.container.paddingAbout
    [:h1.memberTitle "Team Member"]
    [:div {:class "ui grid"}
