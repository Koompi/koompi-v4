(ns koompi.components.privacy)

(defn koompi-privacy []
  [:div.ui.container.containerPrivacy
   [:h1 "Privacy Policy"]
   [:p "Effective date: October 19, 2018"]
   [:p "KOOMPI we operates the https://koompi.com website ."]
   ...
   [:ul
    [:li
     [:strong "Session Cookies."] " We use Session Cookies to operate our Service."]
    [:li
     [:strong "Preference Cookies."] " We use Preference Cookies to remember your preferences and various settings."]
    [:li
     [:strong "Security Cookies."] " We use Security Cookies for security purposes."]]
   [:h2 "Use of Data"]
   [:p "KOOMPI uses the collected data for various purposes:"]
   [:ul
   ...
   [:p "If you are located outside Cambodia and choose to provide information to us, please note that we transfer the data, including Personal Data, to Cambodia and process it there."]
   ...
   [:p "KOOMPI will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information."]
   [:h2 "Disclosure Of Data"]
   [:h3 "Legal Requirements"]
   [:p "KOOMPI may disclose your Personal Data in the good faith belief that such action is necessary to:"]
   [:ul
    [:li "To comply with a legal obligation"]
    [:li "To protect and defend the rights or property of KOOMPI"]
   ...
   [:ul
    [:li "By email: koompi.com@gmail.com"]
    [:li "By visiting this page on our website: https://koompi.com/contact"]]])