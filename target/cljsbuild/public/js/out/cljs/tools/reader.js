...
var G__36600 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__36600;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__36601 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__36601,ch);
...
if(("\\" === ch__$1)){
var ch_36602__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_36602__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_36602__$2);
} else {
}

var G__36603 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__36603;
continue;
}
}
...
var vec__36611 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__36611,(0),null);
var start_column = cljs.core.nth.call(null,vec__36611,(1),null);
...
var G__36614 = cljs.core.conj_BANG_.call(null,a,form);
a = G__36614;
continue;
}
}
...
var _STAR_read_delim_STAR_36615 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_36615;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__36616 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__36616,(0),null);
var start_column = cljs.core.nth.call(null,vec__36616,(1),null);
...
var vec__36619 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__36619,(0),null);
var end_column = cljs.core.nth.call(null,vec__36619,(1),null);
...
var vec__36622 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__36622,(0),null);
var start_column = cljs.core.nth.call(null,vec__36622,(1),null);
...
var vec__36625 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__36625,(0),null);
var end_column = cljs.core.nth.call(null,vec__36625,(1),null);
...
var vec__36628 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__36628,(0),null);
var start_column = cljs.core.nth.call(null,vec__36628,(1),null);
...
var vec__36631 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__36631,(0),null);
var end_column = cljs.core.nth.call(null,vec__36631,(1),null);
...
var sb = (function (){var G__36634 = (new goog.string.StringBuffer());
G__36634.append(initch);
...
var G__36636 = (function (){var G__36635 = sb;
G__36635.append(ch);

return G__36635;
})();
var G__36637 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__36636;
ch = G__36637;
continue;
}
...
switch (G__36640) {
case "\\":
var G__36644 = (function (){var G__36641 = sb;
G__36641.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__36641;
})();
var G__36645 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__36644;
ch = G__36645;
continue;
...
break;
default:
var G__36646 = (function (){var G__36642 = sb;
G__36642.append(ch);

return G__36642;
})();
var G__36647 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__36646;
ch = G__36647;
continue;
...
var vec__36648 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__36648,(0),null);
var end_column = cljs.core.nth.call(null,vec__36648,(1),null);
...
var vec__36651 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__36651,(0),null);
var column = cljs.core.nth.call(null,vec__36651,(1),null);
...
var vec__36656 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__36656,(0),null);
var column = cljs.core.nth.call(null,vec__36656,(1),null);
...
var vec__36661 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__36661,(0),null);
var column = cljs.core.nth.call(null,vec__36661,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__36666 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__36666,(0),null);
var start_column = cljs.core.nth.call(null,vec__36666,(1),null);
...
var vec__36669 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__36669,(0),null);
var end_column = cljs.core.nth.call(null,vec__36669,(1),null);
...
var G__36672 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__36672,true,null,opts,pending_forms);
...
var G__36673 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__36673)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__36673)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__36673)){
...
var _STAR_suppress_read_STAR_36674 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_36674;
}});
...
var G__36675 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__36675,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__36675,rdr,first_line);
...
var G__36679 = matched;
var G__36680 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__36679;
finished = G__36680;
continue;
} else {
...
var _STAR_suppress_read_STAR_36681 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_36681;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env36682 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__36683 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__36683,"(");
...
var G__36684 = (i + (1));
var G__36685 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env36682;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__36686 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__36686);
...
var G__36687 = cljs.core.next.call(null,s__$1);
var G__36688 = ret;
s__$1 = G__36687;
r = G__36688;
continue;
...
var G__36689 = cljs.core.next.call(null,s);
var G__36690 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__36689;
key_vals = G__36690;
continue;
} else {
...
var gensym_env36694 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env36694;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__36695 = token;
var G__36695__$1 = (((G__36695 == null))?null:cljs.core.subs.call(null,G__36695,(1)));
var G__36695__$2 = (((G__36695__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__36695__$1));
var G__36695__$3 = (((G__36695__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__36695__$2));
var G__36695__$4 = (((G__36695__$3 == null))?null:cljs.core.symbol.call(null,G__36695__$3));
if((G__36695__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__36695__$4);
}
})():(function (){var G__36696 = token;
var G__36696__$1 = (((G__36696 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__36696));
if((G__36696__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__36696__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__36707,reader){
...
var eof = cljs.core.get.call(null,map__36708__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4531__auto___36716 = arguments.length;
var i__4532__auto___36717 = (0);
while(true){
if((i__4532__auto___36717 < len__4531__auto___36716)){
args__4534__auto__.push((arguments[i__4532__auto___36717]));

var G__36718 = (i__4532__auto___36717 + (1));
i__4532__auto___36717 = G__36718;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq36714){
var G__36715 = cljs.core.first.call(null,seq36714);
var seq36714__$1 = cljs.core.next.call(null,seq36714);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36715,seq36714__$1);
});


//# sourceMappingURL=reader.js.map?rel=1551156917884
