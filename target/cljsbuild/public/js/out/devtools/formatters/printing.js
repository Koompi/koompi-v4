...
var len__4531__auto___29419 = arguments.length;
var i__4532__auto___29420 = (0);
while(true){
if((i__4532__auto___29420 < len__4531__auto___29419)){
args__4534__auto__.push((arguments[i__4532__auto___29420]));

var G__29421 = (i__4532__auto___29420 + (1));
i__4532__auto___29420 = G__29421;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29416){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29417,G__29418,seq29416__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29422_SHARP_){
return !((cljs.core.meta.call(null,p1__29422_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__29423__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29427){var _e__28151__auto__ = e29427;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e29429){var _e__28151__auto__ = e29429;
return false;
}}
})())){
...
var _STAR_current_state_STAR_29431 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__29432 = opts;
...
var markup_db = cljs.core.get.call(null,map__29432__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_29431;
}});
...
;
var temp__5455__auto___29436 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___29436)){
var managed_print_level_29437 = temp__5455__auto___29436;
var _STAR_print_level_STAR_29435_29438 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_29437;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_29435_29438,managed_print_level_29437,temp__5455__auto___29436,writer,opts,job_fn){
return (function (p1__29434_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__29434_SHARP_,null);
});})(_STAR_print_level_STAR_29435_29438,managed_print_level_29437,temp__5455__auto___29436,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_29435_29438;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1551156883366
