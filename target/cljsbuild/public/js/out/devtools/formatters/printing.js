...
var len__4531__auto___30470 = arguments.length;
var i__4532__auto___30471 = (0);
while(true){
if((i__4532__auto___30471 < len__4531__auto___30470)){
args__4534__auto__.push((arguments[i__4532__auto___30471]));

var G__30472 = (i__4532__auto___30471 + (1));
i__4532__auto___30471 = G__30472;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30467){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30468,G__30469,seq30467__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30473_SHARP_){
return !((cljs.core.meta.call(null,p1__30473_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__30474__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30478){var _e__30125__auto__ = e30478;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e30480){var _e__30125__auto__ = e30480;
return false;
}}
})())){
...
var _STAR_current_state_STAR_30482 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__30483 = opts;
...
var markup_db = cljs.core.get.call(null,map__30483__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_30482;
}});
...
;
var temp__5455__auto___30487 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___30487)){
var managed_print_level_30488 = temp__5455__auto___30487;
var _STAR_print_level_STAR_30486_30489 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_30488;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_30486_30489,managed_print_level_30488,temp__5455__auto___30487,writer,opts,job_fn){
return (function (p1__30485_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__30485_SHARP_,null);
});})(_STAR_print_level_STAR_30486_30489,managed_print_level_30488,temp__5455__auto___30487,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_30486_30489;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1551586167617
