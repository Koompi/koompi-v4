...
if((i < len)){
var k = (ks[i]);
var G__31477 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__31478 = (i + (1));
m = G__31477;
i = G__31478;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__31480 = c;
var G__31480__$1 = (((G__31480 == null))?null:G__31480.prototype);
if((G__31480__$1 == null)){
return null;
} else {
return (G__31480__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__31482 = c;
var G__31482__$1 = (((G__31482 == null))?null:G__31482.prototype);
if((G__31482__$1 == null)){
return null;
} else {
return (G__31482__$1["render"]);
}
})() == null))));
});
...
return (function() { 
var G__31485__delegate = function (args){
...
while (G__31486__i < G__31486__a.length) {G__31486__a[G__31486__i] = arguments[G__31486__i + 0]; ++G__31486__i;}
  args = new cljs.core.IndexedSeq(G__31486__a,0,null);
} 
return G__31485__delegate.call(this,args);};
G__31485.cljs$lang$maxFixedArity = 0;
G__31485.cljs$lang$applyTo = (function (arglist__31487){
var args = cljs.core.seq(arglist__31487);
return G__31485__delegate(args);
});
...
var _STAR_current_component_STAR_31489 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_31489;
}});
...
return ((function (G__31490,G__31490__$1){
...
var c = this;
var G__31495_31497 = (c["cljsRatom"]);
if((G__31495_31497 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__31495_31497);
}
...
var renders_31499 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_31500 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_31499));
if((cljs.core.count.call(null,renders_31499) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_31499))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_31500)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_31500))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__31498 = name;
switch (G__31498) {
case "":
...
var G__31502 = o;
(G__31502[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__31503 = fiber;
var G__31503__$1 = (((G__31503 == null))?null:(G__31503["type"]));
if((G__31503__$1 == null)){
return null;
} else {
return (G__31503__$1["displayName"]);
}
})();
var parent = (function (){var G__31504 = fiber;
if((G__31504 == null)){
return null;
} else {
return (G__31504["return"]);
}
})();
var path = (function (){var G__31505 = parent;
var G__31505__$1 = (((G__31505 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__31505));
if((G__31505__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__31505__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__31507 = c;
if((G__31507 == null)){
return null;
} else {
return (G__31507["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__31508._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__31510 = c;
if((G__31510 == null)){
return null;
} else {
return (G__31510["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__31512 = c;
if((G__31512 == null)){
return null;
} else {
return G__31512._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__31514 = instance;
if((G__31514 == null)){
return null;
} else {
return (G__31514["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__31515 = instance;
if((G__31515 == null)){
return null;
} else {
return G__31515._currentElement;
}
}
})();
var name = (function (){var G__31516 = elem;
var G__31516__$1 = (((G__31516 == null))?null:(G__31516["type"]));
if((G__31516__$1 == null)){
return null;
} else {
return (G__31516__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__31518 = elem;
if((G__31518 == null)){
return null;
} else {
return (G__31518["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__31519._owner;
}
}
})();
var path = (function (){var G__31520 = owner;
var G__31520__$1 = (((G__31520 == null))?null:reagent.impl.component.component_path.call(null,G__31520));
if((G__31520__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__31520__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__31521 = c;
var G__31521__$1 = (((G__31521 == null))?null:G__31521.constructor);
if((G__31521__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__31521__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1551586172776
